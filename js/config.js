...
export const config = {
  ...
  skills: {
    ...
    tools: [
      ...
      { name: "PowerPoint", icon: "powerpoint", color: "#D24726" },
      { name: "Blender", icon: "blender", color: "#E87D0D" },
      { name: "Figma", icon: "figma", color: "#A259FF" },
      { name: "Cinema 4D", icon: "c4d", color: "#011A6B" },
      { name: "Sketch", icon: "sketch", color: "#FDB300" },
      { name: "Word", icon: "word", color: "#2B579A" },
      { name: "DaVinci Resolve", icon: "davinci", color: "#FF6B35" },
    ],
    scrollSpeed: 35,
    categories: [
